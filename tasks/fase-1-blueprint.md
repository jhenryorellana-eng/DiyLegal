...
- [ ] 11. Legal Aid (cheerio) · 12-14. Court Intelligence (eoirFetch+cheerio) · 15. Panel /dev/feeds-test  ← SIGUIENTE

**Infra creada (acumulada):** `cache.ts`, `gemini/client.ts` (REST+grounding), `pdf.ts` (pdf-parse v2). 10 crons en vercel.json.
